...
const projects = [
  ...
  },
  {
    name: "Digi-Clusive",
    description:
      "Although 1 in 5 are disabled, essential platforms, weren't designed with inclusivity in mind. Digi-Clusive mends the digital divide of accessibility and crucial social distancing platforms (Zoom).",
    image: digiclusive,
    technologies: [
      {
        JavaScript: "JavaScript",
